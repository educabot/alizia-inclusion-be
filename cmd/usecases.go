...
func NewUseCases(repos *Repositories, cfg *config.Config) *UseCases {
	...
	return &UseCases{
		...
		AssistClassroom: inclusionuc.NewAssistClassroom(inclusionuc.AssistClassroomDeps{
			AI:            repos.AI,
			Students:      repos.Students,
			Profiles:      repos.StudentProfiles,
			Classrooms:    repos.Classrooms,
			Devices:       repos.Devices,
			Conversations: repos.Conversations,
			Summaries:     repos.ConversationSummaries,
			Adaptations:   repos.Adaptations,
			Content:       repos.PedagogicalContent,
