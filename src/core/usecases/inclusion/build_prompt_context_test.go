...
func TestBuildContext_StudentDimensionLoadsFullContext(t *testing.T) {
	...
	m.adaptations.On("List", mock.Anything, providers.AdaptationFilter{OrgID: testutil.TestOrgID, StudentID: testutil.Ptr(int64(7)), TeacherID: testutil.Ptr(int64(1))}).
...
func TestBuildContext_StudentWithoutProfileAndPPIDegradesGracefully(t *testing.T) {
	...
	m.ppi.On("GetByStudentID", mock.Anything, testutil.TestOrgID, int64(8)).
		Return(nil, providers.ErrNotFound)
	m.adaptations.On("List", mock.Anything, providers.AdaptationFilter{OrgID: testutil.TestOrgID, StudentID: testutil.Ptr(int64(8)), TeacherID: testutil.Ptr(int64(1))}).
