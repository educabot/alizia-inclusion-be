...
func TestListDevices_ReturnsAllDevices(t *testing.T) {
	...
	got, err := catalog.NewListDevices(mock).Execute(ctx, catalog.ListDevicesRequest{OrgID: testutil.TestOrgID, RampID: nil})
...
func TestListDevices_FiltersByRampID(t *testing.T) {
	...
	got, err := catalog.NewListDevices(mock).Execute(ctx, catalog.ListDevicesRequest{
...
func TestListDevices_RejectsNilOrgID(t *testing.T) {
	...
	_, err := catalog.NewListDevices(mock).Execute(ctx, catalog.ListDevicesRequest{OrgID: uuid.Nil, RampID: nil})
